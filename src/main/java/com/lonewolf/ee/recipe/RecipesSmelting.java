...
{
    private final Marker vanillaRecipeMarker = MarkerManager.getMarker("Vanilla Smelting Recipes");

    public void registerRecipes(RecipeManager recipeManager)
    {
        List<FurnaceRecipe> recipes = recipeManager.getRecipesForType(IRecipeType.SMELTING);
